...
img = cv2.imread(r'C:\Users\kirill\PycharmProjects\pythonProject10\tmp2.JPG').astype(np.float32)
img1 = cv2.imread(r'C:\Users\kirill\PycharmProjects\pythonProject10\tmp2.JPG')
def main():
